...
const char lvc::detail::unit<std::ratio<3600>>::value[] = "h";
const char lvc::detail::unit<std::ratio<60>>::value[] = "m";
const char lvc::detail::unit<std::ratio<1>>::value[] = "s";
const char lvc::detail::unit<std::milli>::value[] = "ms";
const char lvc::detail::unit<std::micro>::value[] = "us";
const char lvc::detail::unit<std::nano>::value[] = "ns";
