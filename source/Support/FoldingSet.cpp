...
void FoldingSetNodeID::AddInteger(unsigned long I) {
  if (sizeof(long) == sizeof(int))
    ...
    lvc_unreachable("unexpected sizeof(long)");
  }
}
...
void FoldingSetNodeID::AddString(StringRef String) {
  ...
  switch (Pos - Size) {
  case 1: V = (V << 8) | (unsigned char)String[Size - 3]; LVC_FALLTHROUGH;
  case 2: V = (V << 8) | (unsigned char)String[Size - 2]; LVC_FALLTHROUGH;
