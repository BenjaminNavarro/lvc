...
#include "lvc/Support/Host.h"
#include "lvc/Support/SwapByteOrder.h"
#include "lvc/Support/TargetParser.h"
#include "lvc/Support/VersionTuple.h"
#include <cassert>
#include <cstring>
using namespace lvc;
...
StringRef Triple::getArchTypeName(ArchType Kind) {
  ...
  lvc_unreachable("Invalid ArchType!");
}
...
StringRef Triple::getVendorTypeName(VendorType Kind) {
  ...
  lvc_unreachable("Invalid VendorType!");
}
...
StringRef Triple::getOSTypeName(OSType Kind) {
  ...
  lvc_unreachable("Invalid OSType");
}
...
StringRef Triple::getEnvironmentTypeName(EnvironmentType Kind) {
  ...
  lvc_unreachable("Invalid EnvironmentType!");
}
...
static StringRef getObjectFormatTypeName(Triple::ObjectFormatType Kind) {
  ...
  lvc_unreachable("unknown object format type");
}
...
static Triple::ObjectFormatType getDefaultFormat(const Triple &T) {
  ...
  lvc_unreachable("unknown architecture");
}
...
std::string Triple::normalize(StringRef Str) {
  ...
  for (unsigned Pos = 0; Pos != array_lengthof(Found); ++Pos) {
    ...
    for (unsigned Idx = 0; Idx != Components.size(); ++Idx) {
      ...
      switch (Pos) {
      default: lvc_unreachable("unexpected component type!");
      case 0:
        Arch = parseArch(Comp);
  ...
  if (Vendor == Triple::SUSE && Environment == lvc::Triple::GNUEABI)
...
bool Triple::getMacOSXVersion(unsigned &Major, unsigned &Minor,
  ...
  switch (getOS()) {
  default: lvc_unreachable("unexpected OS for Darwin triple");
  case Darwin:
...
void Triple::getiOSVersion(unsigned &Major, unsigned &Minor,
  ...
  case TvOS:
    ...
    break;
  case WatchOS:
    lvc_unreachable("conflicting triple info");
  }
}
...
static unsigned getArchPointerBitWidth(lvc::Triple::ArchType Arch) {
  switch (Arch) {
  case lvc::Triple::UnknownArch:
    return 0;

  case lvc::Triple::avr:
  case lvc::Triple::msp430:
    return 16;

  case lvc::Triple::aarch64_32:
  case lvc::Triple::amdil:
  case lvc::Triple::arc:
  case lvc::Triple::arm:
  case lvc::Triple::armeb:
  case lvc::Triple::csky:
  case lvc::Triple::hexagon:
  case lvc::Triple::hsail:
  case lvc::Triple::kalimba:
  case lvc::Triple::lanai:
  case lvc::Triple::le32:
  case lvc::Triple::m68k:
  case lvc::Triple::mips:
  case lvc::Triple::mipsel:
  case lvc::Triple::nvptx:
  case lvc::Triple::ppc:
  case lvc::Triple::ppcle:
  case lvc::Triple::r600:
  case lvc::Triple::renderscript32:
  case lvc::Triple::riscv32:
  case lvc::Triple::shave:
  case lvc::Triple::sparc:
  case lvc::Triple::sparcel:
  case lvc::Triple::spir:
  case lvc::Triple::tce:
  case lvc::Triple::tcele:
  case lvc::Triple::thumb:
  case lvc::Triple::thumbeb:
  case lvc::Triple::wasm32:
  case lvc::Triple::x86:
  case lvc::Triple::xcore:
    return 32;

  case lvc::Triple::aarch64:
  case lvc::Triple::aarch64_be:
  case lvc::Triple::amdgcn:
  case lvc::Triple::amdil64:
  case lvc::Triple::bpfeb:
  case lvc::Triple::bpfel:
  case lvc::Triple::hsail64:
  case lvc::Triple::le64:
  case lvc::Triple::mips64:
  case lvc::Triple::mips64el:
  case lvc::Triple::nvptx64:
  case lvc::Triple::ppc64:
  case lvc::Triple::ppc64le:
  case lvc::Triple::renderscript64:
  case lvc::Triple::riscv64:
  case lvc::Triple::sparcv9:
  case lvc::Triple::spir64:
  case lvc::Triple::systemz:
  case lvc::Triple::ve:
  case lvc::Triple::wasm64:
  case lvc::Triple::x86_64:
    return 64;
  }
  lvc_unreachable("Invalid architecture value");
}
...
Triple Triple::getBigEndianArchVariant() const {
  ...
  default:
    lvc_unreachable("getBigEndianArchVariant: unknown triple.");
  }
  return T;
}
...
Triple Triple::getLittleEndianArchVariant() const {
  ...
  default:
    lvc_unreachable("getLittleEndianArchVariant: unknown triple.");
  }
  return T;
}
...
StringRef Triple::getARMCPUForArch(StringRef MArch) const {
  ...
  switch (getOS()) {
  case lvc::Triple::FreeBSD:
  case lvc::Triple::NetBSD:
    if (!MArch.empty() && MArch == "v6")
      return "arm1176jzf-s";
    if (!MArch.empty() && MArch == "v7")
      return "cortex-a8";
    break;
  case lvc::Triple::Win32:
    // FIXME: this is invalid for WindowsCE
    return "cortex-a9";
  case lvc::Triple::IOS:
  case lvc::Triple::MacOSX:
  case lvc::Triple::TvOS:
  case lvc::Triple::WatchOS:
    if (MArch == "v7k")
      return "cortex-a7";
    break;
  default:
  ...
  case lvc::Triple::NetBSD:
    ...
    case lvc::Triple::EABI:
    case lvc::Triple::EABIHF:
    case lvc::Triple::GNUEABI:
    case lvc::Triple::GNUEABIHF:
      return "arm926ej-s";
    default:
      return "strongarm";
    }
  case lvc::Triple::NaCl:
  case lvc::Triple::OpenBSD:
    return "cortex-a8";
  default:
    switch (getEnvironment()) {
    case lvc::Triple::EABIHF:
    case lvc::Triple::GNUEABIHF:
    case lvc::Triple::MuslEABIHF:
      return "arm1176jzf-s";
    default:
      return "arm7tdmi";
    }
  ...
  lvc_unreachable("invalid arch name");
}
