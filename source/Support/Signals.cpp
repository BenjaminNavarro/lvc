...
#include "lvc/Support/FormatAdapters.h"
...
constexpr char DisableSymbolizationEnv[] = "LVC_DISABLE_SYMBOLIZATION";
constexpr char LLVMSymbolizerPathEnv[] = "LVC_SYMBOLIZER_PATH";
...
static bool printSymbolizedStackTrace(StringRef Argv0, void **StackTrace,
  ...
  if (const char *Path = getenv(LLVMSymbolizerPathEnv)) {
    ...
    StringRef Parent = lvc::sys::path::parent_path(Argv0);
    if (!Parent.empty())
