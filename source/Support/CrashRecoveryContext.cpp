...
#include "lvc/Support/CrashRecoveryContext.h"
#include "lvc/Config/llvm-config.h"
#include "lvc/Support/ErrorHandling.h"
#include "lvc/Support/ExitCodes.h"
...
static LONG CALLBACK ExceptionHandler(PEXCEPTION_POINTERS ExceptionInfo)
{
  ...
  lvc_unreachable("Handled the crash, should have longjmp'ed out of here");
}
...
#endif
  lvc_unreachable("Most likely setjmp wasn't called!");
}
...
bool CrashRecoveryContext::RunSafelyOnThread(function_ref<void()> Fn,
  ...
  LVC_execute_on_thread(RunSafelyOnThread_Dispatch, &Info,
                         RequestedStackSize == 0
                             ? lvc::None
                             : lvc::Optional<unsigned>(RequestedStackSize));
