...
#include "lvc/Support/OptimizedStructLayout.h"
...
lvc::performOptimizedStructLayout(MutableArrayRef<Field> Fields) {
#ifndef NDEBUG
  ...
  auto tryAddFillerFromQueue = [&](AlignmentQueue *Queue,
    ...
    lvc_unreachable("didn't find a match in queue despite its MinSize");
  };
