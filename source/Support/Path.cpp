...
using namespace lvc;
using namespace lvc::support::endian;

namespace {
  using lvc::StringRef;
  using lvc::sys::path::is_separator;
  using lvc::sys::path::Style;
...
createTemporaryFile(const Twine &Model, int &ResultFD,
                    lvc::SmallVectorImpl<char> &ResultPath, FSEntity Type,
...
void make_absolute(const Twine &current_directory,
  ...
  lvc_unreachable("All rootName and rootDirectory combinations should have "
                   "occurred above!");
}
