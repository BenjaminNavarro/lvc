...
#include "lvc/Support/CodeGenCoverage.h"
...
#include "lvc/Support/ScopedPrinter.h"
#include "lvc/Support/ToolOutputFile.h"
...
bool CodeGenCoverage::emit(StringRef CoveragePrefix,
  ...
  if (!CoveragePrefix.empty() && !RuleCoverage.empty()) {
    ...
    std::string Pid = lvc::to_string(sys::Process::getProcessId());
