...
#include "lvc/Support/Signposts.h"
...
/// Allows lvc::Timer to emit signposts when supported.
...
std::unique_ptr<raw_fd_ostream> lvc::CreateInfoOutputFile() {
