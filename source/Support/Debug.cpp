...
#include "lvc/Support/circular_raw_ostream.h"
...
static void debug_user_sig_handler(void *Cookie) {
  ...
  lvc::circular_raw_ostream &dbgout =
      static_cast<circular_raw_ostream &>(lvc::dbgs());
  dbgout.flushBufferWithBanner();
}

/// dbgs - Return a circular-buffered debug stream.
raw_ostream &lvc::dbgs() {
...
///
bool lvc::EnableDebugBuffering = false;
