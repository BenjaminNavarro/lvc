...
uint8_t DataExtractor::getU8(uint64_t *offset_ptr, lvc::Error *Err) const {
...
uint16_t DataExtractor::getU16(uint64_t *offset_ptr, lvc::Error *Err) const {
...
uint32_t DataExtractor::getU32(uint64_t *offset_ptr, lvc::Error *Err) const {
...
uint64_t DataExtractor::getU64(uint64_t *offset_ptr, lvc::Error *Err) const {
...
uint64_t DataExtractor::getUnsigned(uint64_t *offset_ptr, uint32_t byte_size,
  ...
  lvc_unreachable("getUnsigned unhandled case!");
}
...
DataExtractor::getSigned(uint64_t *offset_ptr, uint32_t byte_size) const {
  ...
  lvc_unreachable("getSigned unhandled case!");
}
