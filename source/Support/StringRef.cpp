...
#include "lvc/ADT/edit_distance.h"
...
unsigned StringRef::edit_distance(lvc::StringRef Other,
                                  bool AllowReplacements,
                                  unsigned MaxEditDistance) const {
  return lvc::ComputeEditDistance(
...
size_t StringRef::find(StringRef Str, size_t From) const {
  ...
  do {
    ...
    if (LVC_UNLIKELY(Last == (uint8_t)Needle[N - 1]))
...
bool lvc::consumeUnsignedInteger(StringRef &Str, unsigned Radix,
...
bool lvc::consumeSignedInteger(StringRef &Str, unsigned Radix,
                                long long &Result) {
...
bool lvc::getAsUnsignedInteger(StringRef Str, unsigned Radix,
                                unsigned long long &Result) {
...
bool lvc::getAsSignedInteger(StringRef Str, unsigned Radix,
                              long long &Result) {
...
hash_code lvc::hash_value(StringRef S) {
