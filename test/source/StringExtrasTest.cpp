...
TEST(StringExtras, ConvertToSnakeFromCamelCase) {
  auto testConvertToSnakeCase = [](lvc::StringRef input,
                                   lvc::StringRef expected) {
...
TEST(StringExtras, ConvertToCamelFromSnakeCase) {
  auto testConvertToCamelCase = [](bool capitalizeFirst, lvc::StringRef input,
                                   lvc::StringRef expected) {
