...
#ifndef LVC_TESTING_SUPPORT_ERROR_H
#define LVC_TESTING_SUPPORT_ERROR_H
...
#define EXPECT_THAT_ERROR(Err, Matcher)                                        \
  EXPECT_THAT(lvc::detail::TakeError(Err), Matcher)
#define ASSERT_THAT_ERROR(Err, Matcher)                                        \
  ASSERT_THAT(lvc::detail::TakeError(Err), Matcher)

#define EXPECT_THAT_EXPECTED(Err, Matcher)                                     \
  EXPECT_THAT(lvc::detail::TakeExpected(Err), Matcher)
#define ASSERT_THAT_EXPECTED(Err, Matcher)                                     \
  ASSERT_THAT(lvc::detail::TakeExpected(Err), Matcher)
