...
#define LVC_ENABLE_CRASH_DUMPS 0
...
#define LVC_ENABLE_ZLIB 1

/* Define if overriding target triple is enabled */
/* #undef LVC_TARGET_TRIPLE_ENV */

/* LLVM version information */
/* #undef LVC_VERSION_INFO */

/* Whether tools show host and target info when invoked with --version */
#define LVC_VERSION_PRINTER_SHOW_HOST_TARGET_INFO 1

/* Define if libxml2 is supported on this platform. */
#define LVC_ENABLE_LIBXML2 1

/* Define to the extension used for shared libraries, say, ".so". */
#define LTDL_SHLIB_EXT ".so"

/* Define to the extension used for plugin libraries, say, ".so". */
#define LVC_PLUGIN_EXT ".so"
...
#define LVC_GISEL_COV_ENABLED 0

/* Define to the default GlobalISel coverage file prefix */
/* #undef LVC_GISEL_COV_PREFIX */

/* Whether Timers signpost passes in Xcode Instruments */
#define LVC_SUPPORT_XCODE_SIGNPOSTS 0
