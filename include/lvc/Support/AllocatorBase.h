...
#ifndef LVC_SUPPORT_ALLOCATORBASE_H
#define LVC_SUPPORT_ALLOCATORBASE_H
...
public:
  ...
  LVC_ATTRIBUTE_RETURNS_NONNULL void *Allocate(size_t Size, size_t Alignment) {
...
#endif // LVC_SUPPORT_ALLOCATORBASE_H
