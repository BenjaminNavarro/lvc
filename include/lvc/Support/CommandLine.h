...
#ifndef LVC_SUPPORT_COMMANDLINE_H
#define LVC_SUPPORT_COMMANDLINE_H
...
public:
  ...
  bool error(const Twine &Message, StringRef ArgName = StringRef(), raw_ostream &Errs = lvc::errs());
...
struct OptionValueBase : public GenericOptionValue {
  ...
  const DataType &getValue() const { lvc_unreachable("no default value"); }
...
#define clEnumVal(ENUMVAL, DESC)                                               \
  lvc::cl::OptionEnumValue { #ENUMVAL, int(ENUMVAL), DESC }
#define clEnumValN(ENUMVAL, FLAGNAME, DESC)                                    \
  lvc::cl::OptionEnumValue { FLAGNAME, int(ENUMVAL), DESC }
...
public:
  ...
  explicit opt(const Mods &... Ms)
      : Option(lvc::cl::Optional, NotHidden), Parser(*this) {
    apply(this, Ms...);
    done();
  }
...
/// StringMap<lvc::cl::Option*> &opts = lvc::cl::getRegisteredOptions();
/// assert(opts.count("help") == 1)
/// opts["help"]->setDescription("Show alphabetical help information")
/// // More code
/// lvc::cl::ParseCommandLineOptions(argc,argv);
/// //More code
/// }
/// \endcode
///
...
/// lvc::cl::ParseCommandLineOptions().
///
...
/// main(int argc, char* argv[]) {
///   lvc::cl::ParseCommandLineOptions(argc, argv);
///   for (auto* S : lvc::cl::getRegisteredSubcommands()) {
///     if (*S) {
...
bool ExpandResponseFiles(
    ...
    lvc::vfs::FileSystem &FS = *lvc::vfs::getRealFileSystem(),
    lvc::Optional<lvc::StringRef> CurrentDir = lvc::None);
...
#endif // LVC_SUPPORT_COMMANDLINE_H
