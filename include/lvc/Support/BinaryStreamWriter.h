...
#ifndef LVC_SUPPORT_BINARYSTREAMWRITER_H
#define LVC_SUPPORT_BINARYSTREAMWRITER_H
...
public:
  ...
  template <typename T> Error writeInteger(T Value) {
    ...
    lvc::support::endian::write<T, lvc::support::unaligned>(Buffer, Value,
                                                            Stream.getEndian());
...
#endif // LVC_SUPPORT_BINARYSTREAMWRITER_H
