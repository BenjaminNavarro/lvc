...
#ifndef LVC_SUPPORT_BINARYSTREAMREADER_H
#define LVC_SUPPORT_BINARYSTREAMREADER_H

#include "lvc/ADT/ArrayRef.h"
#include "lvc/ADT/STLExtras.h"
#include "lvc/Support/Alignment.h"
#include "lvc/Support/BinaryStreamArray.h"
#include "lvc/Support/BinaryStreamRef.h"
...
public:
  ...
  explicit BinaryStreamReader(StringRef Data, lvc::support::endianness Endian);
  ...
  template <typename T> Error readInteger(T &Dest) {
    ...
    Dest = lvc::support::endian::read<T, lvc::support::unaligned>(
...
#endif // LVC_SUPPORT_BINARYSTREAMREADER_H
