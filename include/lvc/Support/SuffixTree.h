...
//
//===----------------------------------------------------------------------===//
#ifndef LVC_SUPPORT_SUFFIXTREE_H
#define LVC_SUPPORT_SUFFIXTREE_H
...
struct SuffixTreeNode {
  ...
  lvc::DenseMap<unsigned, SuffixTreeNode *> Children;
...
private:
  ...
  lvc::SpecificBumpPtrAllocator<SuffixTreeNode> NodeAllocator;
  ...
  lvc::BumpPtrAllocator InternalEndIdxAllocator;
...
#endif // LVC_SUPPORT_SUFFIXTREE_H
