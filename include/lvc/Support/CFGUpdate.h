...
#ifndef LVC_SUPPORT_CFGUPDATE_H
#define LVC_SUPPORT_CFGUPDATE_H
...
void LegalizeUpdates(ArrayRef<Update<NodePtr>> AllUpdates,
  ...
  lvc::sort(Result, [&](const Update<NodePtr> &A, const Update<NodePtr> &B) {
