...
//===----------------------------------------------------------------------===//
//
// This file declares the lvc::sys::Program class.
//
//===----------------------------------------------------------------------===//

#ifndef LVC_SUPPORT_PROGRAM_H
#define LVC_SUPPORT_PROGRAM_H
...
void printArg(lvc::raw_ostream &OS, StringRef Arg, bool Quote);
