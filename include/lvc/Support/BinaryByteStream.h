...
#ifndef LVC_SUPPORT_BINARYBYTESTREAM_H
#define LVC_SUPPORT_BINARYBYTESTREAM_H

#include "lvc/ADT/ArrayRef.h"
#include "lvc/ADT/StringRef.h"
#include "lvc/Support/BinaryStream.h"
#include "lvc/Support/BinaryStreamError.h"
#include "lvc/Support/Error.h"
#include "lvc/Support/FileOutputBuffer.h"
...
public:
  ...
  BinaryByteStream(ArrayRef<uint8_t> Data, lvc::support::endianness Endian)
      : Endian(Endian), Data(Data) {}
  BinaryByteStream(StringRef Data, lvc::support::endianness Endian)
      : Endian(Endian), Data(Data.bytes_begin(), Data.bytes_end()) {}

  lvc::support::endianness getEndian() const override { return Endian; }
...
public:
  ...
  lvc::support::endianness getEndian() const override {
...
class AppendingBinaryByteStream : public WritableBinaryStream {
  ...
  lvc::support::endianness Endian = lvc::support::little;

public:
  AppendingBinaryByteStream() = default;
  AppendingBinaryByteStream(lvc::support::endianness Endian)
      : Endian(Endian) {}
...
#endif // LVC_SUPPORT_BINARYBYTESTREAM_H
