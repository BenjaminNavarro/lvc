...
// a raw_ostream or converted to a std::string or lvc::SmallString.
//
//   // Convert to std::string.
//   std::string S = formatv("{0} {1}", 1234.412, "test").str();
//
//   // Convert to lvc::SmallString
...
#ifndef LVC_SUPPORT_FORMATVARIADIC_H
#define LVC_SUPPORT_FORMATVARIADIC_H
...
#include "lvc/Support/FormatCommon.h"
#include "lvc/Support/FormatProviders.h"
...
#endif // LVC_SUPPORT_FORMATVARIADIC_H
