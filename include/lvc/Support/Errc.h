//===- llvm/Support/Errc.h - Defines the lvc::errc enum --------*- C++ -*-===//
//
...
#ifndef LVC_SUPPORT_ERRC_H
#define LVC_SUPPORT_ERRC_H
...
namespace std {
template <> struct is_error_code_enum<lvc::errc> : std::true_type {};
} // namespace std
#endif
