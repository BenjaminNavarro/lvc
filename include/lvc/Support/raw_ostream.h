...
#ifndef LVC_SUPPORT_RAW_OSTREAM_H
#define LVC_SUPPORT_RAW_OSTREAM_H
...
public:
  ...
  /// satisfy lvc::isPrint into an escape sequence.
...
public:
  ...
  ///   }
  ///   @endcode
  LVC_NODISCARD Expected<sys::fs::FileLocker> lock();
...
/// lvc::outs for "-", raw_null_ostream for "/dev/null", and raw_fd_ostream
...
#endif // LVC_SUPPORT_RAW_OSTREAM_H
