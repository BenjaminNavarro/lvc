...
/// Use the lvc_unreachable macro (that adds location info), instead of
/// calling this function directly.
LVC_ATTRIBUTE_NORETURN void lvc_unreachable_internal(const char *msg = nullptr,
...
#ifndef NDEBUG
#define lvc_unreachable(msg)                                                   \
  ::lvc::lvc_unreachable_internal(msg, __FILE__, __LINE__)
#elif defined(LVC_BUILTIN_UNREACHABLE)
#define lvc_unreachable(msg) LVC_BUILTIN_UNREACHABLE
#else
#define lvc_unreachable(msg) ::lvc::lvc_unreachable_internal()
#endif
