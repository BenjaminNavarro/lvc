...
#ifndef LVC_SUPPORT_REGISTRY_H
#define LVC_SUPPORT_REGISTRY_H
...
namespace lvc {
  ...
  public:
    ...
    /// the executable (see LVC_INSTANTIATE_REGISTRY below).
    static void add_node(node *N);

    /// Iterators for registry entries.
    ///
    class iterator
        : public lvc::iterator_facade_base<iterator, std::forward_iterator_tag,
                                            const entry> {
      const node *Cur;
    ...
    // data member, instead it's instantiated by LVC_INSTANTIATE_REGISTRY.
...
#define LVC_INSTANTIATE_REGISTRY(REGISTRY_CLASS) \
  namespace lvc { \
