...
#ifndef LVC_SUPPORT_MACHINEVALUETYPE_H
#define LVC_SUPPORT_MACHINEVALUETYPE_H
...
public:
  ...
  MVT getVectorElementType() const {
    switch (SimpleTy) {
    default:
      lvc_unreachable("Not a vector MVT!");
    case v1i1:
    case v2i1:
    case v4i1:
    case v8i1:
  ...
  TypeSize getSizeInBits() const {
    switch (SimpleTy) {
    default:
      lvc_unreachable("getSizeInBits called on extended MVT.");
    case Other:
      lvc_unreachable("Value type is non-standard value, Other.");
    case iPTR:
      lvc_unreachable("Value type size is target-dependent. Ask TLI.");
    case iPTRAny:
    case iAny:
    case fAny:
    case vAny:
    case Any:
      lvc_unreachable("Value type is overloaded.");
    case token:
      lvc_unreachable("Token type is a sentinel that cannot be used "
                      "in codegen and has no size");
    case Metadata:
      lvc_unreachable("Value type is metadata.");
    case i1:
    case v1i1:
...
#endif // LVC_SUPPORT_MACHINEVALUETYPE_H
