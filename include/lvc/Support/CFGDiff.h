...
#ifndef LVC_SUPPORT_CFGDIFF_H
#define LVC_SUPPORT_CFGDIFF_H

#include "lvc/ADT/GraphTraits.h"
#include "lvc/ADT/iterator.h"
#include "lvc/ADT/iterator_range.h"
#include "lvc/Support/CFGUpdate.h"
...
auto reverse_if_helper(Range &&R, std::integral_constant<bool, true>) {
  return lvc::reverse(std::forward<Range>(R));
}
...
public:
  ...
  LVC_DUMP_METHOD void dump() const { print(dbgs()); }
#endif
};
} // end namespace lvc

#endif // LVC_SUPPORT_CFGDIFF_H
