...
//
//   void fn() {
//     std::unique_ptr<MyBaseClass> B = lvc::make_unique<MyDerivedClass1>();
//     lvc::outs() << isa<MyBaseClass>(B) << "\n"; // Outputs "1".
//     lvc::outs() << isa<MyDerivedClass1>(B) << "\n"; // Outputs "1".
//     lvc::outs() << isa<MyDerivedClass2>(B) << "\n"; // Outputs "0'.
//   }
//
//   @endcode
//
...
#ifndef LVC_SUPPORT_EXTENSIBLERTTI_H
#define LVC_SUPPORT_EXTENSIBLERTTI_H
...
#endif // LVC_SUPPORT_EXTENSIBLERTTI_H
