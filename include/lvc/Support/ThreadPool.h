...
#ifndef LVC_SUPPORT_THREADPOOL_H
#define LVC_SUPPORT_THREADPOOL_H

#include "lvc/Config/llvm-config.h"
#include "lvc/Support/Threading.h"
#include "lvc/Support/thread.h"
...
#if LVC_ENABLE_THREADS // avoids warning for unused variable
...
#endif // LVC_SUPPORT_THREADPOOL_H
