...
#ifndef LVC_SUPPORT_CRASHRECOVERYCONTEXT_H
#define LVC_SUPPORT_CRASHRECOVERYCONTEXT_H
...
public:
  ...
  ///
  /// See RunSafely() and LVC_execute_on_thread().
  ///
...
#endif // LVC_SUPPORT_CRASHRECOVERYCONTEXT_H
