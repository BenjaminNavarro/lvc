...
#ifndef LVC_SUPPORT_GRAPHWRITER_H
#define LVC_SUPPORT_GRAPHWRITER_H

#include "lvc/ADT/GraphTraits.h"
#include "lvc/ADT/StringRef.h"
#include "lvc/ADT/Twine.h"
#include "lvc/Support/DOTGraphTraits.h"
...
std::string WriteGraph(const GraphType &G, const Twine &Name,
  ...
  lvc::WriteGraph(O, G, ShortNames, Title);
  errs() << " done. \n";
...
void ViewGraph(const GraphType &G, const Twine &Name,
               ...
               GraphProgram::Name Program = GraphProgram::DOT) {
  std::string Filename = lvc::WriteGraph(G, Name, ShortNames, Title);
...
#endif // LVC_SUPPORT_GRAPHWRITER_H
