...
#ifndef LVC_SUPPORT_BINARYSTREAM_H
#define LVC_SUPPORT_BINARYSTREAM_H
...
enum BinaryStreamFlags {
  ...
  LVC_MARK_AS_BITMASK_ENUM(/* LargestValue = */ BSF_Append)
};
...
public:
  ...
  virtual lvc::support::endianness getEndian() const = 0;
...
#endif // LVC_SUPPORT_BINARYSTREAM_H
