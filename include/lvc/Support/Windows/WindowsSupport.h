...
#ifndef LVC_SUPPORT_WINDOWSSUPPORT_H
#define LVC_SUPPORT_WINDOWSSUPPORT_H
...
#include "lvc/Config/config.h" // Get build system configuration settings
...
lvc::VersionTuple GetWindowsOSVersion();

bool MakeErrMsg(std::string *ErrMsg, const std::string &prefix);

// Include GetLastError() in a fatal error message.
LVC_ATTRIBUTE_NORETURN inline void ReportLastErrorFatal(const char *Msg) {
  std::string ErrMsg;
  MakeErrMsg(&ErrMsg, Msg);
  lvc::report_fatal_error(ErrMsg);
}
