...
#ifndef LVC_SUPPORT_FORMATADAPTERS_H
#define LVC_SUPPORT_FORMATADAPTERS_H
...
public:
  ...
  void format(lvc::raw_ostream &Stream, StringRef Style) override {
...
// lvc::Error values must be consumed before being destroyed.
