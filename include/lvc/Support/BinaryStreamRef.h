...
#ifndef LVC_SUPPORT_BINARYSTREAMREF_H
#define LVC_SUPPORT_BINARYSTREAMREF_H
...
public:
  lvc::support::endianness getEndian() const {
...
public:
  ...
  explicit BinaryStreamRef(StringRef Data, lvc::support::endianness Endian);
...
#endif // LVC_SUPPORT_BINARYSTREAMREF_H
