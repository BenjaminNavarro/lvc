...
#ifndef LVC_SUPPORT_FILECOLLECTOR_H
#define LVC_SUPPORT_FILECOLLECTOR_H
...
protected:
  ...
  virtual lvc::vfs::directory_iterator
  addDirectoryImpl(const lvc::Twine &Dir,
...
#endif // LVC_SUPPORT_FILECOLLECTOR_H
