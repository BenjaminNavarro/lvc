...
#ifndef LVC_SUPPORT_FILEUTILITIES_H
#define LVC_SUPPORT_FILEUTILITIES_H
...
class AtomicFileWriteError : public lvc::ErrorInfo<AtomicFileWriteError> {
public:
...
lvc::Error writeFileAtomically(StringRef TempPathModel, StringRef FinalPath,
                               StringRef Buffer);
