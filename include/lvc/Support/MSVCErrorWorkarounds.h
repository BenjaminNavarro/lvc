...
#ifndef LVC_SUPPORT_MSVCERRORWORKAROUNDS_H
#define LVC_SUPPORT_MSVCERRORWORKAROUNDS_H

#include "lvc/Support/Error.h"

namespace lvc {

// A default-constructible lvc::Error that is suitable for use with MSVC's
...
// A default-constructible lvc::Expected that is suitable for use with MSVC's
// std::future implementation, which requires default constructible types.
...
#endif // LVC_SUPPORT_MSVCERRORWORKAROUNDS_H
