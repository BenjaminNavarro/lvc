...
#ifndef LVC_SUPPORT_TARGETREGISTRY_H
#define LVC_SUPPORT_TARGETREGISTRY_H
...
#include "lvc/Support/FormattedStream.h"
...
private:
  ...
  /// MCRelocationInfo, if registered (default = lvc::createMCRelocationInfo)
  MCRelocationInfoCtorTy MCRelocationInfoCtorFn = nullptr;

  /// MCSymbolizerCtorFn - Construction function for this target's
  /// MCSymbolizer, if registered (default = lvc::createMCSymbolizer)
...
public:
  ...
  MCStreamer *createMCObjectStreamer(const Triple &T, MCContext &Ctx,
    ...
    case Triple::UnknownObjectFormat:
      lvc_unreachable("Unknown object format");
    case Triple::COFF:
  ...
  MCStreamer *createAsmStreamer(MCContext &Ctx,
    ...
    MCStreamer *S = lvc::createAsmStreamer(
  ...
  MCStreamer *createNullStreamer(MCContext &Ctx) const {
    MCStreamer *S = lvc::createNullStreamer(Ctx);
  ...
  createMCSymbolizer(StringRef TT, LLVMOpInfoCallback GetOpInfo,
    ...
    MCSymbolizerCtorTy Fn =
        MCSymbolizerCtorFn ? MCSymbolizerCtorFn : lvc::createMCSymbolizer;
...
#endif // LVC_SUPPORT_TARGETREGISTRY_H
