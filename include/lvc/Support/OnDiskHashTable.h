...
///
//===----------------------------------------------------------------------===//
#ifndef LVC_SUPPORT_ONDISKHASHTABLE_H
#define LVC_SUPPORT_ONDISKHASHTABLE_H

#include "lvc/Support/Alignment.h"
#include "lvc/Support/Allocator.h"
#include "lvc/Support/DataTypes.h"
#include "lvc/Support/EndianStream.h"
...
template <typename Info> class OnDiskChainedHashTableGenerator {
  ...
  lvc::SpecificBumpPtrAllocator<Item> BA;
...
///
/// \copydetails lvc::OnDiskChainedHashTable
