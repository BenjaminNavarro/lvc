...
#ifndef LVC_SUPPORT_ALLOCATOR_H
#define LVC_SUPPORT_ALLOCATOR_H

#include "lvc/ADT/Optional.h"
#include "lvc/ADT/SmallVector.h"
#include "lvc/Support/Alignment.h"
#include "lvc/Support/AllocatorBase.h"
...
public:
...
#if LVC_ADDRESS_SANITIZER_BUILD
  ...
  inline LVC_ATTRIBUTE_RETURNS_NONNULL LVC_ATTRIBUTE_RETURNS_NOALIAS void *
  ...
  lvc::Optional<int64_t> identifyObject(const void *Ptr) {
...
operator new(size_t Size,
             lvc::BumpPtrAllocatorImpl<AllocatorT, SlabSize, SizeThreshold,
                                       GrowthDelay> &Allocator) {
  return Allocator.Allocate(Size, std::min((size_t)lvc::NextPowerOf2(Size),
...
void operator delete(void *,
                     lvc::BumpPtrAllocatorImpl<AllocatorT, SlabSize,
                                               SizeThreshold, GrowthDelay> &) {}

#endif // LVC_SUPPORT_ALLOCATOR_H
