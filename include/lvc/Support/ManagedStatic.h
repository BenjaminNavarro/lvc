...
//===----------------------------------------------------------------------===//
//
// This file defines the ManagedStatic class and the LVC_shutdown() function.
//
//===----------------------------------------------------------------------===//

#ifndef LVC_SUPPORT_MANAGEDSTATIC_H
#define LVC_SUPPORT_MANAGEDSTATIC_H
...
#define LVC_USE_CONSTEXPR_CTOR
#endif

/// ManagedStaticBase - Common base class for ManagedStatic instances.
class ManagedStaticBase {
protected:
#ifdef LVC_USE_CONSTEXPR_CTOR
...
/// explicit through the LVC_shutdown() function call.
///
...
/// LVC_shutdown_obj - This is a simple helper class that calls
/// LVC_shutdown() when it is destroyed.
struct LVC_shutdown_obj {
  LVC_shutdown_obj() = default;
  ~LVC_shutdown_obj() { LVC_shutdown(); }
};

} // end namespace lvc

#endif // LVC_SUPPORT_MANAGEDSTATIC_H
