...
//===----------------------------------------------------------------------===//
//
// This file declares the lvc::sys::fs namespace. It is designed after
...
#ifndef LVC_SUPPORT_FILESYSTEM_H
#define LVC_SUPPORT_FILESYSTEM_H
...
#include "lvc/Support/FileSystem/UniqueID.h"
#include "lvc/Support/MD5.h"
#include <cassert>
#include <cstdint>
#include <ctime>
#include <memory>
...
class FileLocker {
  ...
  friend class lvc::raw_fd_ostream;
...
#endif // LVC_SUPPORT_FILESYSTEM_H
