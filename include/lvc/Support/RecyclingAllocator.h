...
#ifndef LVC_SUPPORT_RECYCLINGALLOCATOR_H
#define LVC_SUPPORT_RECYCLINGALLOCATOR_H

#include "lvc/Support/Recycler.h"
...
inline void *operator new(
    size_t size,
    lvc::RecyclingAllocator<AllocatorType, T, Size, Align> &Allocator) {
...
operator delete(void *E,
                lvc::RecyclingAllocator<AllocatorType, T, Size, Align> &A) {
  A.Deallocate(E);
}
