...
#ifndef LVC_IR_LLVMCONTEXT_H
#define LVC_IR_LLVMCONTEXT_H

#include "llvm-c/Types.h"
#include "lvc/IR/DiagnosticHandler.h"
...
public:
  ...
  enum : unsigned {
#define LVC_FIXED_MD_KIND(EnumID, Name, Value) EnumID = Value,
#include "lvc/IR/FixedMetadataKinds.def"
#undef LVC_FIXED_MD_KIND
  };
  ...
  /// lvc::remarks::Remark and emit them through this streamer.
