...
#ifndef LVC_IR_CONSTANTS_H
#define LVC_IR_CONSTANTS_H
...
class ConstantData : public Constant {
  ...
  Value *handleOperandChangeImpl(Value *From, Value *To) {
    lvc_unreachable("Constant data does not have operands!");
  }
...
public:
  ...
  /// Return the constant as an lvc::MaybeAlign.
  ...
  /// Return the constant as an lvc::Align, interpreting `0` as `Align(1)`.
  /// Note that this method can assert if the value does not fit in 64 bits or
  /// is not a power of two.
