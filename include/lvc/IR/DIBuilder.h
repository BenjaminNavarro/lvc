...
#ifndef LVC_IR_DIBUILDER_H
#define LVC_IR_DIBUILDER_H
...
#include "lvc/IR/DebugInfo.h"
#include "lvc/IR/DebugInfoMetadata.h"
#include "lvc/IR/TrackingMDRef.h"
...
namespace lvc {
  ...
  class DIBuilder {
    ...
    Instruction *insertDeclare(lvc::Value *Storage, DILocalVariable *VarInfo,
    ...
    Instruction *
    insertDbgValueIntrinsic(lvc::Value *Val, DILocalVariable *VarInfo,
                            DIExpression *Expr, const DILocation *DL,
                            BasicBlock *InsertBB, Instruction *InsertBefore);
  ...
  public:
    ...
    /// \param Storage     lvc::Value of the variable
    ...
    /// \param Val          lvc::Value of the variable
    /// \param VarInfo      Variable's debug info descriptor.
    /// \param Expr         A complex location expression.
    /// \param DL           Debug info location.
    /// \param InsertAtEnd Location for the new intrinsic.
    Instruction *insertDbgValueIntrinsic(lvc::Value *Val,
