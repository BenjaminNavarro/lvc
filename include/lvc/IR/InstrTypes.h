...
#ifndef LVC_IR_INSTRTYPES_H
#define LVC_IR_INSTRTYPES_H
...
#include "lvc/IR/Instruction.def"
#define HANDLE_UNARY_INST(N, OPC, CLASS) \
  static UnaryOperator *Create##OPC(Value *V, const Twine &Name, \
                                    BasicBlock *BB) {\
...
public:
  ...
  explicit OperandBundleDefT(const OperandBundleUse &OBU) {
    ...
    lvc::append_range(Inputs, OBU.Inputs);
  }
...
protected:
  ...
  unsigned getNumSubclassExtraOperands() const {
    ...
    lvc_unreachable("Invalid opcode!");
  }
...
public:
  ...
  bool hasArgument(const Value *V) const {
    return lvc::is_contained(args(), V);
  }
  ...
  LVC_ATTRIBUTE_DEPRECATED(unsigned getRetAlignment() const,
  ...
  LVC_ATTRIBUTE_DEPRECATED(unsigned getParamAlignment(unsigned ArgNo) const,
  ...
  bool isFnAttrDisallowedByOpBundle(Attribute::AttrKind A) const {
    ...
    lvc_unreachable("switch has a default case!");
  }
