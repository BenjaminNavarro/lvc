...
#ifndef LVC_IR_ABSTRACTCALLSITE_H
#define LVC_IR_ABSTRACTCALLSITE_H
...
public:
  ...
  ///
  /// An abstract call site can only be constructed through a lvc::Use because
  /// each operand (=use) of an instruction could potentially be a different
  /// abstract call site. Furthermore, even if the value of the lvc::Use is the
  ...
  /// constructed abstract call site will behave as a lvc::CallSite would.
  ///
...
#endif // LVC_IR_ABSTRACTCALLSITE_H
