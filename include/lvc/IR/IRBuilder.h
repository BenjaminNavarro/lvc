...
#ifndef LVC_IR_IRBUILDER_H
#define LVC_IR_IRBUILDER_H
...
#include "lvc/IR/BasicBlock.h"
#include "lvc/IR/Constant.h"
#include "lvc/IR/ConstantFolder.h"
#include "lvc/IR/Constants.h"
#include "lvc/IR/DataLayout.h"
#include "lvc/IR/DebugInfoMetadata.h"
#include "lvc/IR/DebugLoc.h"
#include "lvc/IR/DerivedTypes.h"
#include "lvc/IR/Function.h"
#include "lvc/IR/GlobalVariable.h"
#include "lvc/IR/InstrTypes.h"
#include "lvc/IR/Instruction.h"
#include "lvc/IR/Instructions.h"
#include "lvc/IR/IntrinsicInst.h"
#include "lvc/IR/LLVMContext.h"
#include "lvc/IR/Module.h"
#include "lvc/IR/Operator.h"
#include "lvc/IR/Type.h"
#include "lvc/IR/Value.h"
#include "lvc/IR/ValueHandle.h"
#include "lvc/Support/AtomicOrdering.h"
#include "lvc/Support/CBindingWrapping.h"
...
public:
  ...
  CallInst *CreateAssumption(Value *Cond,
                             ArrayRef<OperandBundleDef> OpBundles = lvc::None);
...
public:
  ...
  LVC_ATTRIBUTE_DEPRECATED(LoadInst *CreateLoad(Value *Ptr,
                                                 const char *Name),
  ...
  // Deprecated [opaque pointer types]
  LVC_ATTRIBUTE_DEPRECATED(LoadInst *CreateAlignedLoad(Value *Ptr,
                                                        MaybeAlign Align,
                                                        const char *Name),
                            "Use the version that explicitly specifies the "
                            "loaded type instead") {
  ...
  CreateAtomicCmpXchg(Value *Ptr, Value *Cmp, Value *New, MaybeAlign Align,
    ...
    if (!Align) {
      const DataLayout &DL = BB->getModule()->getDataLayout();
      Align = lvc::Align(DL.getTypeStoreSize(New->getType()));
    }
  ...
  AtomicRMWInst *CreateAtomicRMW(AtomicRMWInst::BinOp Op, Value *Ptr,
    ...
    if (!Align) {
      const DataLayout &DL = BB->getModule()->getDataLayout();
      Align = lvc::Align(DL.getTypeStoreSize(Val->getType()));
    }
...
public:
  ...
  LVC_ATTRIBUTE_DEPRECATED(Value *CreateShuffleVector(Value *V1, Value *V2,
