...
#ifndef LVC_IR_BASICBLOCK_H
#define LVC_IR_BASICBLOCK_H

#include "llvm-c/Types.h"
#include "lvc/ADT/Twine.h"
#include "lvc/ADT/ilist.h"
...
public:
  ...
  const Instruction *getTerminator() const LVC_READONLY;
