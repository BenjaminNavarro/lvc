...
#ifndef LVC_IR_DEBUGINFOMETADATA_H
#define LVC_IR_DEBUGINFOMETADATA_H

#include "lvc/ADT/ArrayRef.h"
#include "lvc/ADT/BitmaskEnum.h"
...
#include "lvc/BinaryFormat/Dwarf.h"
#include "lvc/IR/Constants.h"
#include "lvc/IR/Metadata.h"
...
#include "lvc/IR/DebugInfoFlags.def"
    ...
    LVC_MARK_AS_BITMASK_ENUM(SPFlagLargest)
  };
...
public:
  ...
  lvc::Optional<SignedOrUnsignedConstant> isConstant() const;
  ...
  /// instance of the operand `DW_OP_LVC_arg, \p ArgNo`. This is used to
  ...
  /// `DW_OP_LVC_arg, \p OldArg` replaced with `DW_OP_LVC_arg, \p NewArg`,
  /// and each instance of `DW_OP_LVC_arg, Arg` with `DW_OP_LVC_arg, Arg - 1`
  ...
  /// is fragmented across multiple Values. The DW_OP_LVC_fragment operation
  /// will be appended to the elements of \c Expr. If \c Expr already contains
  /// a \c DW_OP_LVC_fragment \c OffsetInBits is interpreted as an offset
  ...
  bool isEntryValue() const {
    return getNumElements() > 0 &&
           getElement(0) == dwarf::DW_OP_LVC_entry_value;
  }
};
...
#endif // LVC_IR_DEBUGINFOMETADATA_H
