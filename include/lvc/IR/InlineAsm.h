...
#ifndef LVC_IR_INLINEASM_H
#define LVC_IR_INLINEASM_H
...
public:
  ...
  static StringRef getKindName(unsigned Kind) {
    ...
    case InlineAsm::Kind_Mem:
      return "mem";
    default:
      lvc_unreachable("Unknown operand kind");
    }
  }
  ...
  static StringRef getMemConstraintName(unsigned Constraint) {
    ...
    case InlineAsm::Constraint_Zy:
      return "Zy";
    default:
      lvc_unreachable("Unknown memory constraint");
    }
  }
};
