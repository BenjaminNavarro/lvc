...
#ifndef LVC_IR_DIAGNOSTICINFO_H
#define LVC_IR_DIAGNOSTICINFO_H
...
static DiagnosticSeverity getDiagnosticSeverity(SourceMgr::DiagKind DK) {
  switch (DK) {
  case lvc::SourceMgr::DK_Error:
    return DS_Error;
    break;
  case lvc::SourceMgr::DK_Warning:
    return DS_Warning;
    break;
  case lvc::SourceMgr::DK_Note:
    return DS_Note;
    break;
  case lvc::SourceMgr::DK_Remark:
    return DS_Remark;
    break;
  }
  lvc_unreachable("unknown SourceMgr::DiagKind");
}
