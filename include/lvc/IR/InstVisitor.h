...
#ifndef LVC_IR_INSTVISITOR_H
#define LVC_IR_INSTVISITOR_H
...
public:
  ...
  RetTy visit(Instruction &I) {
    ...
    switch (I.getOpcode()) {
    default: lvc_unreachable("Unknown instruction type encountered!");
...
private:
  ...
  RetTy delegateCallInst(Instruction &I) {
    lvc_unreachable("delegateCallInst called for non-CallInst");
  }
};
