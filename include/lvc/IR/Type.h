...
#ifndef LVC_IR_TYPE_H
#define LVC_IR_TYPE_H
...
public:
  ...
  const fltSemantics &getFltSemantics() const {
    ...
    default: lvc_unreachable("Invalid floating type");
    }
  }
  ...
  ///
  TypeSize getPrimitiveSizeInBits() const LVC_READONLY;

  /// If this is a vector type, return the getPrimitiveSizeInBits value for the
  /// element type. Otherwise return the getPrimitiveSizeInBits value for this
  /// type.
  unsigned getScalarSizeInBits() const LVC_READONLY;
  ...
  template <typename ScalarTy> static Type *getScalarTy(LLVMContext &C) {
    ...
    lvc_unreachable("Unsupported type in Type::getScalarTy");
  }
