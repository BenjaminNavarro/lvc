...
#ifndef LVC_IR_METADATA_H
#define LVC_IR_METADATA_H
...
protected:
  ...
  void handleChangedOperand(void *, Metadata *) {
    lvc_unreachable("Unimplemented in Metadata subclass");
  }
...
protected:
  ...
  void operator delete(void *, unsigned) {
    lvc_unreachable("Constructor throws?");
  }
