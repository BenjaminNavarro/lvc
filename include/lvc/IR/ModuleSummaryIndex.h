...
#ifndef LVC_IR_MODULESUMMARYINDEX_H
#define LVC_IR_MODULESUMMARYINDEX_H
...
inline const char *getHotnessName(CalleeInfo::HotnessType HT) {
  ...
  lvc_unreachable("invalid hotness");
}
...
#endif // LVC_IR_MODULESUMMARYINDEX_H
