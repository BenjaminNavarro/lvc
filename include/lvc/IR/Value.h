...
#ifndef LVC_IR_VALUE_H
#define LVC_IR_VALUE_H
...
public:
  ...
  void replaceUsesWithIf(Value *New,
                         lvc::function_ref<bool(Use &U)> ShouldReplace) {
  ...
  /// uses.
  void dropDroppableUses(lvc::function_ref<bool(const Use *)> ShouldDrop =
