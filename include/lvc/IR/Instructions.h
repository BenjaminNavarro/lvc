...
#ifndef LVC_IR_INSTRUCTIONS_H
#define LVC_IR_INSTRUCTIONS_H
...
#include "lvc/ADT/iterator.h"
#include "lvc/ADT/iterator_range.h"
#include "lvc/IR/Attributes.h"
#include "lvc/IR/BasicBlock.h"
#include "lvc/IR/CallingConv.h"
#include "lvc/IR/CFG.h"
...
#include "lvc/IR/OperandTraits.h"
#include "lvc/IR/Type.h"
#include "lvc/IR/Use.h"
#include "lvc/IR/User.h"
...
public:
  ...
  getStrongestFailureOrdering(AtomicOrdering SuccessOrdering) {
    ...
    default:
      lvc_unreachable("invalid cmpxchg success ordering");
...
public:
  ...
  bool isComplete() const {
    return lvc::all_of(predecessors(getParent()),
...
private:
  BasicBlock *getSuccessor(unsigned idx) const {
    lvc_unreachable("ReturnInst has no successors!");
  }
...
public:
  ...
  ConstCaseIt findCaseValue(const ConstantInt *C) const {
    ConstCaseIt I = lvc::find_if(cases(), [C](ConstCaseHandle &Case) {
...
private:
  BasicBlock *getSuccessor(unsigned idx) const {
    lvc_unreachable("ResumeInst has no successors!");
  }
...
private:
  BasicBlock *getSuccessor(unsigned idx) const {
    lvc_unreachable("UnreachableInst has no successors!");
  }
