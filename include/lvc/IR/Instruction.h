...
#ifndef LVC_IR_INSTRUCTION_H
#define LVC_IR_INSTRUCTION_H
...
public:
  ...
  ///
  bool isAssociative() const LVC_READONLY;
  ...
  /// applied to any type.
  ///
  bool isCommutative() const LVC_READONLY;
