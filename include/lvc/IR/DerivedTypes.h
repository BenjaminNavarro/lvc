...
#ifndef LVC_IR_DERIVEDTYPES_H
#define LVC_IR_DERIVEDTYPES_H
...
public:
  ...
  create(StringRef Name, Type *elt1, Tys *... elts) {
    ...
    SmallVector<lvc::Type *, 8> StructFields({elt1, elts...});
  ...
  get(Type *elt1, Tys *... elts) {
    ...
    SmallVector<lvc::Type *, 8> StructFields({elt1, elts...});
    return lvc::StructType::get(Ctx, StructFields);
  }
  ...
  static VectorType *getTruncatedElementVectorType(VectorType *VTy) {
    ...
    if (VTy->getElementType()->isFloatingPointTy()) {
      ...
      case FloatTyID:
        ...
        break;
      default:
        lvc_unreachable("Cannot create narrower fp vector element type");
      }
    } else {
      unsigned EltBits = VTy->getElementType()->getPrimitiveSizeInBits();
      assert((EltBits & 1) == 0 &&
