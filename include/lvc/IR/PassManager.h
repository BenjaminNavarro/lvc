...
#ifndef LVC_IR_PASSMANAGER_H
#define LVC_IR_PASSMANAGER_H
...
#include "lvc/IR/PassInstrumentation.h"
#include "lvc/IR/PassManagerInternal.h"
#include "lvc/Pass.h"
#include "lvc/Support/Debug.h"
#include "lvc/Support/TimeProfiler.h"
#include "lvc/Support/TypeName.h"
#include <algorithm>
#include <cassert>
#include <cstring>
#include <iterator>
...
template <typename DerivedT> struct PassInfoMixin {
  ...
  static StringRef name() {
    ...
    if (Name.startswith("lvc::"))
      Name = Name.drop_front(strlen("lvc::"));
    return Name;
  }
};
...
public:
  ...
  ///
  /// If \p DebugLogging is true, we'll log our progress to lvc::dbgs().
...
public:
  ...
  void clear(IRUnitT &IR, lvc::StringRef Name);
...
private:
  ...
  /// Indicates whether we log to \c lvc::dbgs().
  bool DebugLogging;
};
  ...
  public:
    ...
    bool invalidate(
      ...
      for (auto &KeyValuePair : OuterAnalysisInvalidationMap) {
        ...
        lvc::erase_if(InnerIDs, [&](AnalysisKey *InnerID) {
    ...
    void registerOuterAnalysisInvalidation() {
      ...
      if (!lvc::is_contained(InvalidatedIDList, InvalidatedID))
