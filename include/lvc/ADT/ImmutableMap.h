...
#ifndef LVC_ADT_IMMUTABLEMAP_H
#define LVC_ADT_IMMUTABLEMAP_H
...
public:
  ...
  public:
    ...
    LVC_NODISCARD ImmutableMap add(ImmutableMap Old, key_type_ref K,
                                    data_type_ref D) {
      TreeTy *T = F.add(Old.Root.get(), std::pair<key_type, data_type>(K, D));
      return ImmutableMap(Canonicalize ? F.getCanonicalTree(T) : T);
    }

    LVC_NODISCARD ImmutableMap remove(ImmutableMap Old, key_type_ref K) {
