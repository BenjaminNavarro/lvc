...
#ifndef LVC_ADT_SMALLPTRSET_H
#define LVC_ADT_SMALLPTRSET_H
...
public:
  ...
  LVC_NODISCARD bool empty() const { return size() == 0; }
...
inline void swap(lvc::SmallPtrSet<T, N> &LHS, lvc::SmallPtrSet<T, N> &RHS) {
  LHS.swap(RHS);
}

} // end namespace std

#endif // LVC_ADT_SMALLPTRSET_H
