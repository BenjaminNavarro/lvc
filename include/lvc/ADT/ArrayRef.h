...
#ifndef LVC_ADT_ARRAYREF_H
#define LVC_ADT_ARRAYREF_H
...
/// value.
template <typename T> class LVC_GSL_POINTER LVC_NODISCARD ArrayRef {
public:
  using value_type = T;
...
/// value.
template <typename T>
class LVC_NODISCARD MutableArrayRef : public ArrayRef<T> {
public:
  using value_type = T;
  using pointer = value_type *;
  using const_pointer = const value_type *;
