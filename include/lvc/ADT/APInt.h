...
#ifndef LVC_ADT_APINT_H
#define LVC_ADT_APINT_H
...
private:
  ...
  /// out-of-line slow case for operator==
  bool EqualSlowCase(const APInt &RHS) const LVC_READONLY;

  /// out-of-line slow case for countLeadingZeros
  unsigned countLeadingZerosSlowCase() const LVC_READONLY;

  /// out-of-line slow case for countLeadingOnes.
  unsigned countLeadingOnesSlowCase() const LVC_READONLY;

  /// out-of-line slow case for countTrailingZeros.
  unsigned countTrailingZerosSlowCase() const LVC_READONLY;

  /// out-of-line slow case for countTrailingOnes
  unsigned countTrailingOnesSlowCase() const LVC_READONLY;

  /// out-of-line slow case for countPopulation
  unsigned countPopulationSlowCase() const LVC_READONLY;

  /// out-of-line slow case for intersects.
  bool intersectsSlowCase(const APInt &RHS) const LVC_READONLY;

  /// out-of-line slow case for isSubsetOf.
  bool isSubsetOfSlowCase(const APInt &RHS) const LVC_READONLY;
  ...
  int compare(const APInt &RHS) const LVC_READONLY;

  /// Signed comparison. Returns -1, 0, or 1 if this APInt is less than, equal
  /// to, or greater than RHS.
  int compareSigned(const APInt &RHS) const LVC_READONLY;
...
public:
  ...
  unsigned countLeadingZeros() const {
    if (isSingleWord()) {
      ...
      return lvc::countLeadingZeros(U.VAL) - unusedBits;
    }
  ...
  unsigned countLeadingOnes() const {
    if (isSingleWord())
      return lvc::countLeadingOnes(U.VAL << (APINT_BITS_PER_WORD - BitWidth));
  ...
  unsigned countTrailingZeros() const {
    if (isSingleWord())
      return std::min(unsigned(lvc::countTrailingZeros(U.VAL)), BitWidth);
  ...
  unsigned countTrailingOnes() const {
    if (isSingleWord())
      return lvc::countTrailingOnes(U.VAL);
  ...
  unsigned countPopulation() const {
    if (isSingleWord())
      return lvc::countPopulation(U.VAL);
