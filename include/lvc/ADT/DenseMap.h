...
#ifndef LVC_ADT_DENSEMAP_H
#define LVC_ADT_DENSEMAP_H

#include "lvc/ADT/DenseMapInfo.h"
#include "lvc/ADT/EpochTracker.h"
#include "lvc/Support/AlignOf.h"
#include "lvc/Support/Compiler.h"
#include "lvc/Support/MathExtras.h"
#include "lvc/Support/MemAlloc.h"
#include "lvc/Support/ReverseIteration.h"
...
template <typename KeyT, typename ValueT,
          ...
          typename Bucket = lvc::detail::DenseMapPair<KeyT, ValueT>,
          bool IsConst = false>
...
public:
  ...
  LVC_NODISCARD bool empty() const { return getNumEntries() == 0; }
...
private:
  ...
  BucketT *InsertIntoBucketImpl(const KeyT &Key, const LookupKeyT &Lookup,
    ...
    if (LVC_UNLIKELY(NewNumEntries * 4 >= NumBuckets * 3)) {
      this->grow(NumBuckets * 2);
      LookupBucketFor(Lookup, TheBucket);
      NumBuckets = getNumBuckets();
    } else if (LVC_UNLIKELY(NumBuckets -
  ...
  bool LookupBucketFor(const LookupKeyT &Val,
    ...
    while (true) {
      ...
      if (LVC_LIKELY(KeyInfoT::isEqual(Val, ThisBucket->getFirst()))) {
      ...
      if (LVC_LIKELY(KeyInfoT::isEqual(ThisBucket->getFirst(), EmptyKey))) {
...
template <typename KeyT, typename ValueT,
          typename KeyInfoT = DenseMapInfo<KeyT>,
          typename BucketT = lvc::detail::DenseMapPair<KeyT, ValueT>>
