...
#ifndef LVC_ADT_IMMUTABLESET_H
#define LVC_ADT_IMMUTABLESET_H
...
public:
  ...
  public:
    ...
    LVC_NODISCARD ImmutableSet add(ImmutableSet Old, value_type_ref V) {
    ...
    ///  The memory allocated to represent the set is released when the
    ///  factory object that created the set is destroyed.
    LVC_NODISCARD ImmutableSet remove(ImmutableSet Old, value_type_ref V) {
