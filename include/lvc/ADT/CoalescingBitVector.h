...
#ifndef LVC_ADT_COALESCINGBITVECTOR_H
#define LVC_ADT_COALESCINGBITVECTOR_H
...
#if !defined(NDEBUG) || defined(LVC_NABLE_DUMP)
...
#endif // LVC_ADT_COALESCINGBITVECTOR_H
