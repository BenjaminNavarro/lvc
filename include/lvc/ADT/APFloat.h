...
#ifndef LVC_ADT_APFLOAT_H
#define LVC_ADT_APFLOAT_H

#include "lvc/ADT/APInt.h"
#include "lvc/ADT/ArrayRef.h"
#include "lvc/ADT/FloatingPointMode.h"
...
struct APFloatBase {
  ...
  static const lvc::fltSemantics &EnumToSemantics(Semantics S);
  static Semantics SemanticsToEnum(const lvc::fltSemantics &Sem);

  static const fltSemantics &IEEEhalf() LVC_READNONE;
  static const fltSemantics &BFloat() LVC_READNONE;
  static const fltSemantics &IEEEsingle() LVC_READNONE;
  static const fltSemantics &IEEEdouble() LVC_READNONE;
  static const fltSemantics &IEEEquad() LVC_READNONE;
  static const fltSemantics &PPCDoubleDouble() LVC_READNONE;
  static const fltSemantics &x87DoubleExtended() LVC_READNONE;

  /// A Pseudo fltsemantic used to construct APFloats that cannot conflict with
  /// anything real.
  static const fltSemantics &Bogus() LVC_READNONE;
  ...
  using roundingMode = lvc::RoundingMode;
...
class APFloat : public APFloatBase {
  ...
  APFloat() : U(IEEEdouble()) {
    lvc_unreachable("This is a workaround for old clang.");
  }
