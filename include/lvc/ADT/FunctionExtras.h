...
#ifndef LVC_ADT_FUNCTIONEXTRAS_H
#define LVC_ADT_FUNCTIONEXTRAS_H
...
using EnableIfTrivial =
    std::enable_if_t<lvc::is_trivially_move_constructible<T>::value &&
...
protected:
  ...
  using AdjustedParamT = typename std::conditional<
      !std::is_reference<T>::value &&
          lvc::is_trivially_copy_constructible<T>::value &&
          lvc::is_trivially_move_constructible<T>::value &&
...
#endif // LVC_ADT_FUNCTIONEXTRAS_H
