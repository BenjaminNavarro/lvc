...
#ifndef LVC_ADT_SIMPLE_ILIST_H
#define LVC_ADT_SIMPLE_ILIST_H

#include "lvc/ADT/ilist_base.h"
#include "lvc/ADT/ilist_iterator.h"
#include "lvc/ADT/ilist_node.h"
#include "lvc/ADT/ilist_node_options.h"
...
/// LVC_ENABLE_ABI_BREAKING_CHECKS are enabled).
...
public:
  ...
  LVC_NODISCARD bool empty() const { return Sentinel.empty(); }

  /// Calculate the size of the list in linear time.
  LVC_NODISCARD size_type size() const {
