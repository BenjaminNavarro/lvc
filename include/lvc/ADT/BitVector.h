...
#ifndef LVC_ADT_BITVECTOR_H
#define LVC_ADT_BITVECTOR_H
...
public:
  ...
  static BitVector &apply(F &&f, BitVector &Out, BitVector const &Arg,
                          ArgTys const &...Args) {
    assert(lvc::all_of(std::initializer_list<unsigned>{Args.size()...},
...
inline void swap(lvc::BitVector &LHS, lvc::BitVector &RHS) { LHS.swap(RHS); }
} // end namespace std

#endif // LVC_ADT_BITVECTOR_H
