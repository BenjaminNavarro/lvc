...
#ifndef LVC_ADT_TRIPLE_H
#define LVC_ADT_TRIPLE_H
...
public:
  ...
  lvc::Triple get32BitArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  lvc::Triple get64BitArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  lvc::Triple getBigEndianArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  lvc::Triple getLittleEndianArchVariant() const;
