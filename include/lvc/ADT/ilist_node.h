...
#ifndef LVC_ADT_ILIST_NODE_H
#define LVC_ADT_ILIST_NODE_H

#include "lvc/ADT/ilist_node_base.h"
...
/// LVC_ENABLE_ABI_BREAKING_CHECKS.  The function \a isKnownSentinel() always
