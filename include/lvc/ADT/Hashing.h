...
#ifndef LVC_ADT_HASHING_H
#define LVC_ADT_HASHING_H

#include "lvc/Support/DataTypes.h"
...
/// \code
///   using lvc::hash_value;
///   lvc::hash_code code = hash_value(x);
/// \endcode
class hash_code {
  size_t value;
...
///
/// This variable can be set using the \see lvc::set_fixed_execution_seed
...
hash_code hash_combine_range(InputIteratorT first, InputIteratorT last) {
  return ::lvc::hashing::detail::hash_combine_range_impl(first, last);
}
  ...
  char *combine_data(size_t &length, char *buffer_ptr, char *buffer_end,
    ...
    if (!store_and_advance(buffer_ptr, buffer_end, data)) {
      ...
      if (!store_and_advance(buffer_ptr, buffer_end, data, partial_store_size))
        lvc_unreachable("buffer smaller than stored type");
    }
    return buffer_ptr;
  }
...
template <typename... Ts> hash_code hash_combine(const Ts &...args) {
  ...
  ::lvc::hashing::detail::hash_combine_recursive_helper helper;
...
template <typename T>
std::enable_if_t<is_integral_or_enum<T>::value, hash_code> hash_value(T value) {
  return ::lvc::hashing::detail::hash_integer_value(
...
template <typename... Ts> hash_code hash_value(const std::tuple<Ts...> &arg) {
  ...
  return ::lvc::hashing::detail::hash_value_tuple_helper(
