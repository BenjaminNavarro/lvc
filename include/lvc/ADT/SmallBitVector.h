...
#ifndef LVC_ADT_SMALLBITVECTOR_H
#define LVC_ADT_SMALLBITVECTOR_H
...
inline void swap(lvc::SmallBitVector &LHS, lvc::SmallBitVector &RHS) {
  LHS.swap(RHS);
}

} // end namespace std

#endif // LVC_ADT_SMALLBITVECTOR_H
