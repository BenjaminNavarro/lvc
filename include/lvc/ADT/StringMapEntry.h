...
#ifndef LVC_ADT_STRINGMAPENTRY_H
#define LVC_ADT_STRINGMAPENTRY_H
...
protected:
  ...
  /// could be reused elsewhere, maybe even taking an lvc::function_ref to
...
#endif // LVC_ADT_STRINGMAPENTRY_H
