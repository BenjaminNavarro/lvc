...
#ifndef LVC_ADT_STRINGREF_H
#define LVC_ADT_STRINGREF_H
...
class LVC_GSL_POINTER StringRef {
public:
...
public:
  ...
  LVC_NODISCARD StringRef copy(Allocator &A) const {
